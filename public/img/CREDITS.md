# Image credits & license verification
...
## transition-summit-mentors.jpg

- **Used on:** Landing page "mission band" (`app/page.tsx`)
- **Title:** "Transition Summit helps military job seekers" (Image 3 of 7)
...
- **Used on:** Pathfinder intro (`app/pathfinder/page.tsx`)
- **Title:** "TAP in: Bliss Transition Assistance Program partners with industry, prepares
  transitioning Soldiers for careers in demand" (Image 2 of 8)
