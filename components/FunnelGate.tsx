  ...
  return (
    <Wrap narrow>
      <div className="card" style={{ textAlign: "center", padding: "44px 28px", marginTop: 24 }}>
        ...
        <h2 style={{ margin: "0 0 8px" }}>First, build your gameplan</h2>
        ...
        <Link className="btn gold" href="/onboarding" style={{ display: "inline-flex" }}>
          <i className="ti ti-compass" /> Build my gameplan
        </Link>
        <p className="small muted" style={{ margin: "18px 0 0" }}>
          About 10 minutes · free · <Link href="/trust">why you can trust it</Link>
        </p>
      </div>
    </Wrap>
  );
