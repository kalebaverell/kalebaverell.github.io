...
const PHASES: { id: string; label: string; window: string; lede: string; items: Item[] }[] = [
  ...
  },
  {
    ...
    items: [
      { t: "Complete TAP (Transition Assistance Program)", n: "Required by law - begin no later than 365 days before separation. If you are retiring rather than separating, the statute expects it to start as soon as possible inside the 24 months before your date. Pick the track matching your goal: employment, education, or entrepreneurship.", src: SRC.tap, key: true, due: true },
